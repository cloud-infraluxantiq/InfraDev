...
resource "google_cloud_run_service_iam_member" "firebase_auth" {
  ...
  member   = var.iam_member  # Example: "serviceAccount:firebase-auth@project.iam.gserviceaccount.com"
...
output "cloud_run_url" {
  ...
  description = "Live URL of the deployed Django Cloud Run API service"
}
